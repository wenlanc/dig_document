		...
		>
			<Box className={classes.modal} sx={modalStyles}>
				<form onSubmit={handleSubmit}>
					...
					<Typography sx={{ mt: 2 }} key={editAble}>
								...
								<Grid container spacing={2}>
									<Grid item md={12}>
										<SuiInput
											...
											variant='outlined'
											fullWidth
											value={data?.livingSquaredFootage}
											required
											type='number'
											style={{ marginBottom: 16 }}
										/>
				...
				{title === 'Add' && (
					<Typography
						...
						textAlign={'justify'}
					>
						The above is the bare minimum information required to
						Add a Property on digpads. Adding the below information
						will help you better manage your rental properties on
						the digpads platform, but it is optional and may be
						added later if desired as well.
					</Typography>
				)}
			</Box>
		</Modal>
